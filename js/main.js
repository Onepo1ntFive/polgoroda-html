...
(function () {
  var dropdownBtns = document.querySelectorAll('.js-dropdown-show');
  var dropdownBlock = document.querySelector('.js-dropdown-menu');
...
(function () {
  ...
  if (document.querySelector('.js-range')) {
    var sliderSelectors = document.querySelectorAll('.js-range');
    var sliderSlider = null;
    var sliderSliderMinInput = null;
    var sliderSliderMsxInput = null;
    var min = null;
    var max = null;
    var step = null;
  ...
  var accBtns = document.querySelectorAll('.js-acc-title');
  var accContent = null;
  ...
  var showSidebarBtns = document.querySelectorAll('.js-sidebar-filter-show');
  var hideSidebarBtns = document.querySelectorAll('.js-sidebar-filter-hide');
  ...
  var sidebar = document.querySelector('.js-sidebar-filter');
  var sidebarBg = document.querySelector('.js-sidebar-filter-bg');
...
(function () {
  if (document.querySelector('.js-collapse-title')) {
    var collpaseTitle = document.querySelector('.js-collapse-title');
    var collpaseContent = document.querySelector('.js-collapse-content');
    var windowWidth = window.innerWidth;
    collpaseTitle.addEventListener('click', function (event) {
      windowWidth = window.innerWidth;
...
(function () {
  ...
  var sidebarLogo = document.querySelector('.js-menu-logo');
...
(function () {
  var swiperCarousel = new Swiper('.swiper-container-category', {
    speed: 600,
    watchSlidesVisibility: true,
    slideToClickedSlide: true,
    navigation: {
...
(function () {
  ...
  swiperGallery.on('init', function (e) {
...
(function () {
  var swiperGallery = new Swiper('.swiper-container-main', {
    speed: 600,
    loop: true,
    effect: 'fade',
    parallax: true,
